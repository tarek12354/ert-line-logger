      ...
      <CardContent className="pt-4">
        ...
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <ReferenceLine x={RESISTIVITY_THRESHOLDS.WATER} stroke="hsl(210, 100%, 50%)" strokeDasharray="5 5" />
              <ReferenceLine x={RESISTIVITY_THRESHOLDS.VOID} stroke="hsl(0, 84%, 60%)" strokeDasharray="5 5" />
              <Area 
                type="monotone" 
                dataKey="resistivity"
        ...
        <div className="mt-4 grid grid-cols-3 gap-2 text-xs">
          <div className="flex items-center gap-1">
            ...
            <span className="text-muted-foreground">{'>'} {RESISTIVITY_THRESHOLDS.VOID} Ω·m (Vide)</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 rounded-full bg-blue-500" />
            <span className="text-muted-foreground">{'<'} {RESISTIVITY_THRESHOLDS.WATER} Ω·m (Eau)</span>
          </div>
          <div className="flex items-center gap-1">
          ...
          <table className="w-full text-xs">
            <thead className="sticky top-0 bg-background">
              <tr className="border-b border-border">
                ...
                <th className="text-left p-2 text-muted-foreground">Prof.</th>
